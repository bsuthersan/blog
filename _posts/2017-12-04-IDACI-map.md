...
The Leaflet.js package itself is really easy to use and deploy, and can be built layer-by-layer. First, we set the map view by calling the coordinates that we want the map to centre on (51.5131224, -0.21997120000003179), as well as the zoom (in this case, 12.4)
